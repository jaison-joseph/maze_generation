...
* Compile `genetic_3.cpp` with the following options: 
    ...
    with openmp,  g++ -std=c++17 -O3 -Wl,-stack_size -Wl,0x1000000 -pthread -Xpreprocessor -fopenmp -I/opt/homebrew/opt/libomp/include genetic_3.cpp -o runner
   
    g++ on Linux: g++ -std=c++17 -pthread -O3 -Wl,-z,stack-size=16777216 genetic_3.cpp -o `executable_name`
